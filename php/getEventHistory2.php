...
function getSensorList($db,$sub){
     	$sql = "SELECT  eventKey,eventName,eventDevice,time,subscriber,timeStr from sptest_TeleHealthcareFlow__Event where subscriber like '" .$sub . "%'";
