...
import "./ith-edit-event-list-itembathroom.js";
import './ith-event-add-edit-dialog.js';
import '../../elements/ith-dropdown-menu/ith-dropdown-menu.js';

class IthEditEventListViewBathroom extends (PolymerElement) {
  static get template() {
    return html`
      ...
      <div class="container">
        ...
        <div class="layout horizontal header-list-container">
          <div class="flex-1 layout vertical center-justified border header-cell-content">Sensor Type</div>
          <div class="flex-3 layout vertical center-justified border header-cell-content desc-content">Select Sensor Used</div>
          <!--<div class="flex-1 layout vertical center-justified border header-cell-content">Select</div>-->
        </div>
        <div>
       
          <ith-edit-event-list-itembathroom  class="event-item" email="[[email]]" id="update" on-add-event="getDetails"></ith-edit-event-list-itembathroom>
  ...
  getDetails(event) {
        ...
        var evts = [];   
          ...
          // evtDetails.category = evtTemplate.category;
           evtDetails.timeOut= evtTemplate.timeOut;
...
window.customElements.define('ith-edit-event-list-viewbathroom', IthEditEventListViewBathroom);
