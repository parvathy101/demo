...
import "./ith-event-list-itembathroom.js";
import './ith-event-add-edit-dialog.js';
import '../../elements/ith-dropdown-menu/ith-dropdown-menu.js';

class IthEventListViewBathroom extends (PolymerElement) {
  static get template() {
    return html`
      ...
      <div class="container">
        ...
        <div>
          ...
          <ith-event-list-itembathroom  class="event-item" email="[[email]]" id="update" on-add-event="getDetails"></ith-event-list-itembathroom>
...
window.customElements.define('ith-event-list-viewbathroom', IthEventListViewBathroom);
