...
class IthEditEventListItemBathroom extends PolymerElement {
  static get template() {
    return html`
      ...
      <div class="layout horizontal">
        ...
        <!-- <ith-dropdown-menu 
            ...
            on-value-changed="_insidevalue"
                ...
                <input id="insidetag" disabled  value=""/>
       ...
       <div class="layout horizontal">
        ...
        <div class="flex-1 title-content cell-content border" id="outside">Outside Sensor</div>
         <div class="flex-3 desc-content border">
                ...
                <input id="outsidetag" disabled value=""/>
 ...
 _outsidevalue(e)
  {
   ...
   eload(dev,gen)
   {
    ...
    this.$.timeout.value=gen+" min";
      
     for(var i=0;i<this.sel.length;i++)
      {
        
     
       if(this.sel[i].endsWith("1") )
         {
          
             // this.insidedev=this.sel[i].split('-')[0]; 
           //alert(this.insidedev);
           // this.$.insidetag.value=this.sel[i].split('-')[0]; 
            this.$['insidetag'].value=this.sel[i].split('-')[0];
         
         }
       else if(this.sel[i].endsWith("2"))
         {
           //this.outsidedev=this.sel[i].split('-')[0]; 
           //alert(this.outsidedev);
            this.$.outsidetag.value=this.sel[i].split('-')[0]; 
         }
...
window.customElements.define('ith-edit-event-list-itembathroom', IthEditEventListItemBathroom);
