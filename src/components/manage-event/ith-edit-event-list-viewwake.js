...
import "./ith-edit-event-list-itemwake.js";
import './ith-event-add-edit-dialog.js';
import '../../elements/ith-dropdown-menu/ith-dropdown-menu.js';

class IthEditEventListViewWake extends (PolymerElement) {
  static get template() {
    return html`
      ...
      <div class="container">
        ...
        <div>
          ...
          <ith-edit-event-list-itemwake  class="event-item" email="[[email]]" id="update" on-add-event="getDetails"></ith-edit-event-list-itemwake>
...
window.customElements.define('ith-edit-event-list-viewwake', IthEditEventListViewWake);
