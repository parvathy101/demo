...
import "./ith-edit-event-list-itembreakfast.js";
import './ith-event-add-edit-dialog.js';
import '../../elements/ith-dropdown-menu/ith-dropdown-menu.js';

class IthEditEventListViewBreakFast extends (PolymerElement) {
  static get template() {
    return html`
      ...
      <div class="container">
        ...
        <div>
          ...
          <ith-edit-event-list-itembreakfast  class="event-item" email="[[email]]" id="update" on-add-event="getDetails"></ith-edit-event-list-itembreakfast>
...
window.customElements.define('ith-edit-event-list-viewbreakfast', IthEditEventListViewBreakFast);
