...
import './ith-edit-event-list-viewbathroom';
import '../../shared-styles/shared-styles';
import './ith-parameter-list-view';

class IthEditTemplateListViewBathroom extends PolymerElement {
  static get template() {
    return html`
    ...
    //  *{ -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; margin:0;padding:0;}
      ...
      <div class="add-template-view-container">
        <ith-edit-event-list-viewbathroom id="eventlist" email="[[email]]"></ith-edit-event-list-viewbathroom>
...
window.customElements.define('ith-edit-template-list-viewbathroom', IthEditTemplateListViewBathroom);
