...
import './ith-edit-event-list-viewwake';
import '../../shared-styles/shared-styles';
import './ith-parameter-list-view';

class IthEditTemplateListViewWake extends PolymerElement {
  static get template() {
    return html`
    ...
    //  *{ -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; margin:0;padding:0;}
      ...
      <div class="add-template-view-container">
        <ith-edit-event-list-viewwake id="eventlist" email="[[email]]"></ith-edit-event-list-viewwake>
...
window.customElements.define('ith-edit-template-list-viewwake', IthEditTemplateListViewWake);
