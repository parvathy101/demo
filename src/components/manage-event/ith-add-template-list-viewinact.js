...
import './ith-event-list-viewinact';
import '../../shared-styles/shared-styles';
import './ith-parameter-list-view';

class IthAddTemplateListViewInAct extends PolymerElement {
  static get template() {
    return html`
    ...
    //  *{ -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; margin:0;padding:0;}
      ...
      <div class="add-template-view-container">
        <ith-event-list-viewinact id="eventlist" email="[[email]]" on-add-event="addNewEvent"></ith-event-list-viewinact>
...
window.customElements.define('ith-add-template-list-viewinact', IthAddTemplateListViewInAct);
