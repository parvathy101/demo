      ...
      <div class="container">
       ...
       <paper-toast id="toast"></paper-toast>
        ...
        <div class="layout horizontal header-list-container">
          <div class="flex-1 layout vertical center-justified border header-cell-content">Selected Sensors</div>
        ...
        <div>
          ...
          <ith-edit-event-list-iteminact  class="event-item" email="[[email]]" id="update" on-add-event="getDetails"></ith-edit-event-list-iteminact>
...
window.customElements.define('ith-edit-event-list-viewinact', IthEditEventListViewInAct);
