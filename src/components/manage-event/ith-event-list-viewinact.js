      ...
      <div class="container">
       ...
       <paper-toast id="toast"></paper-toast>
        ...
        <div>
          ...
          <ith-event-list-iteminact  class="event-item" email="[[email]]" id="update" on-add-event="getDetails"></ith-event-list-iteminact>
...
_changePage()
{
 ...
 connectedCallback(){
  ...
  _appendedToday(time) {
      ...
      console.log("appendtoday:---"+today + ' ' + time);
      return today + ' ' + time;
  }
...
_translate() {
      ...
      if (tt == "Time Period") {
          ...
          //time.startTime = this._appendedToday(this.$.startTime.value);
            ...
            console.log("nextdate sdt :---"+sdt);
            console.log("nextdate1 sdt.getTime():---"+sdt.getTime());
            console.log("nextdate2 Math.floor(sdt.getTime()):---"+Math.floor(sdt.getTime()));
...
window.customElements.define('ith-event-list-viewinact', IthEventListViewInAct);
