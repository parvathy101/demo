...
import '../../elements/ith-dropdown-menu/ith-textbox.js';

class IthEditTemplateBasicDetailsView extends (PolymerElement) {
  static get template() {
    return html`
        ...
        <div class="view-container layout horizontal flex-1"> 
          ...
          <div class="container layout vertical flex-1">
            <div class="basic-detail-title ">Template name</div>
               ...
               <input id="name" placeholder="eg. Getting out of Bed" disabled style ="width:500px; margin-left:20px">
            
            <div class="basic-detail-title "></div>
            <div class="basic-detail-title">Short description</div>
            <textarea id="description" rows="5" autocomplete="off" disabled style ="width:500px; margin-left:20px">
            </textarea>
            <div class="basic-detail-title "></div>
            <div class="basic-detail-title">Event Type</div>
              <ith-textbox 
            class="flex-1 dropdown-margin textcolor" 
             value="{{event.category}}" 
            name="category"
             items="[[_eventTemplateCategories]]"
            id="category"
            on-value-changed="_value"
            style ="width:500px; height:100px; margin-left:20px; color:black;"
            disabled
          </ith-textbox>
          </div>
...
window.customElements.define('ith-edit-template-basic-details-view', IthEditTemplateBasicDetailsView);
