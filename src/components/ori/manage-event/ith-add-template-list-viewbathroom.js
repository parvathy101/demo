...
import './ith-event-list-viewbathroom';
import '../../shared-styles/shared-styles';
import './ith-parameter-list-view';

class IthAddTemplateListViewBathroom extends PolymerElement {
  static get template() {
    return html`
    ...
    //  *{ -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; margin:0;padding:0;}
      ...
      <div class="add-template-view-container">
        <ith-event-list-viewbathroom id="eventlist" email="[[email]]"></ith-event-list-viewbathroom>
...
window.customElements.define('ith-add-template-list-viewbathroom', IthAddTemplateListViewBathroom);
