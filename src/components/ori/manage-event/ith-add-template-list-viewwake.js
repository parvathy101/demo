...
import './ith-event-list-viewwake';
import '../../shared-styles/shared-styles';
import './ith-parameter-list-view';

class IthAddTemplateListViewWake extends PolymerElement {
  static get template() {
    return html`
    ...
    //  *{ -webkit-box-sizing: border-box; -moz-box-sizing: border-box; box-sizing: border-box; margin:0;padding:0;}
      ...
      <div class="add-template-view-container">
        <ith-event-list-viewwake id="eventlist" email="[[email]]"></ith-event-list-viewwake>
...
window.customElements.define('ith-add-template-list-viewwake', IthAddTemplateListViewWake);
