...
class IthManageEventSearchListView extends (PolymerElement) {
  static get template() {
    ...
    <div class="advance-search-main-container">
     ...
     <telehealthcareflow-associateeventdef id="associateeventdef" on-associated-eventdef="_addedTemplates" on-associateeventdef-error="_onerror"></telehealthcareflow-associateeventdef>
    `;
  }
