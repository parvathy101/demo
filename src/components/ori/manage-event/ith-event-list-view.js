...
class IthEventListView extends (PolymerElement) {
    ...
    return html`
      ...
      <div class="container">
        ...
        <div>
          ...
          <ith-event-list-item  class="event-item" email="[[email]]" id="update"></ith-event-list-item>
        
</div>
      </div>
      <ith-event-add-edit-dialog id="addeditevent" on-add-event="addNewEvent" email="[[email]]"></ith-event-add-edit-dialog>
    `;
  }
  ...
  _openEventAddEditDialog(e){
      ...
      this.$.addeditevent.load();
      
  }
_editEvent(event)
{
console.log(event.detail.list+"llll");   
this._eventList=event.detail.list;
}
  _deleteEvent(e) {
