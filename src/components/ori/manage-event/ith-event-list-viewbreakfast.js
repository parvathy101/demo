...
import "./ith-event-list-itembreakfast.js";
import './ith-event-add-edit-dialog.js';
import '../../elements/ith-dropdown-menu/ith-dropdown-menu.js';

class IthEventListViewBreakFast extends (PolymerElement) {
  static get template() {
    return html`
      ...
      <div class="container">
        ...
        <div>
          ...
          <ith-event-list-itembreakfast  class="event-item" email="[[email]]" id="update" on-add-event="getDetails"></ith-event-list-itembreakfast>
...
window.customElements.define('ith-event-list-viewbreakfast', IthEventListViewBreakFast);
