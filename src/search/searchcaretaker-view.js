...
class SearchCareTakerView extends (GestureEventListeners(PolymerElement)) {
  static get template() {
    return html`
         ...
         <div class="empty-div"></div>
          <div class="flex-2 layout vertical search-container">
            ...
            <iron-input class="search-input">
                <input id="search" value="[[searchQuery]]" placeholder="Enter Care giver name to assign" 
...
window.customElements.define('searchcaretaker-view', SearchCareTakerView);
