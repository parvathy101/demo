...
class ItnTextBox extends mixinBehaviors([IronFormElementBehavior], PolymerElement) {
  static get template() {
    return html`
      ...
      <vaadin-dropdown-menu placeholder="[[placeholder]]" label="[[label]]" value="{{value}}" name="[[name]]" disabled>
        <template>
          <vaadin-list-box>
...
window.customElements.define('ith-textbox', ItnTextBox);
