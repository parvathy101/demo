...
class TeleHealthcareFlowCaretakerSearchAssign extends PolymerElement {
  static get template() {
    return html`
  ...
  assignCaretaker(subscriber, email, name, phone, type, priority) {
     this.$.client._dataChanged();
      this._postEvent = "assigncaregiver.php";
      var postData = {};
...
window.customElements.define('telehealthcareflow-caretakersearchassign', TeleHealthcareFlowCaretakerSearchAssign);
