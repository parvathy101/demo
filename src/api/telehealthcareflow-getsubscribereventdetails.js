...
type: String
  ...
  _handleResponse(data) {
      console.log(data.detail.responses);
          ...
          var response= data.detail.responses.records;
   
if(response!=undefined)
     {
    this.dispatchEvent(new CustomEvent("subscriber-events", { detail: { 'data': response }}));
}
else if(response==undefined)
     {
    var response2=data.detail.responses.responses[0].session;
