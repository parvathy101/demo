...
class TeleHealthcareFlowSearchSubscribers extends PolymerElement {
  static get template() {
    return html`
      <iron-ajax 
                 auto id="ajax"
                 url="http://178.128.165.237/php/api/smart/getSubscribers.php"
                 body='{"searchval":"[[val]]"}'
  ...
  handleResponse(e) {
    ...
    var response = e.detail.response.subscribers;
...
window.customElements.define('telehealthcareflow-searchsubscribers', TeleHealthcareFlowSearchSubscribers);
